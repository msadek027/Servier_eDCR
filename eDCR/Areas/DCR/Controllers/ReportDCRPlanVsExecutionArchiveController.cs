...
{
    public class ReportDCRPlanVsExecutionArchiveController : Controller
    {
        ...
        public ActionResult frmReportDCRPlanVsExecutionArchive()
        {
        ...
        public ActionResult GetMainGrid(DefaultParameterBEO model)
        {
            ...
            var data = primaryDAO.GetMainGridArchive(model);
