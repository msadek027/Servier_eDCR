...
{
    public class PromotionalItemStarFormatDataUploadController : Controller
    {
        ExceptionHandler exceptionHandler = new ExceptionHandler();
        PromotionalItemUploadDAO IteamsUploadDAO = new PromotionalItemUploadDAO();
        public ActionResult frmPromotionalItemStarFormatDataUpload()
        {
        ...
        public ActionResult LoadExcelFile(string fileName, string FileType)
        {
            ...
            dtTemp.Columns.Add("SBU", typeof(string));
            dtTemp.Columns.Add("MarketGroup", typeof(string));
            ...
            try
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    if (!excelSheets[t].Contains("Print_Area"))
                    {
                ...
                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow row2 in dt.Rows)
                    {
                        ...
                        dr["ProductCode"] = row2["SAP code"].ToString();
                        dr["SBU"] = row2["SBU"].ToString();
                        dr["MarketGroup"] = "R1";
                ...
                listData = IteamsUploadDAO.GetStarFormatDataMap(dtTemp);
        ...
        public ActionResult LoadTextFile(string fileName, string FileType)
        {
            ...
            try
            {
                ...
                listData = IteamsUploadDAO.GetStarFormatDataMap(dt);
        ...
        public ActionResult OperationsMode(PromotionalItemFormatDataUploadBEO model)
        {
            try
            {
                if (IteamsUploadDAO.SaveUpdateStarFormatData(model))
                {
