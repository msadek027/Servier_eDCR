...
{
    public class InvProductDataUploadController : Controller
    {
        ItemDataUploadDAO itemDataUploadDAO = new ItemDataUploadDAO();
        ExceptionHandler exceptionHandler = new ExceptionHandler();
        Object data = null;
        public ActionResult frmInvProductDataUpload()
        {
        ...
        {
            string FileName = "InvProduct.xlsx";
        ...
        public ActionResult OperationsMode(ItemDataUploadBEL model)
        {
            try
            {
                if (itemDataUploadDAO.SaveUpdateProduct(model))
                {
        ...
        public ActionResult OperationsDeleteMode(ItemDataUploadBEL model)
        {
            try
            {
                if (itemDataUploadDAO.DeleteProduct(model))
                {
                    return Json(new { ID = itemDataUploadDAO.MaxID, Mode = itemDataUploadDAO.IUMode, Status = "Yes" });
                }
                else
        ...
        {
            data = itemDataUploadDAO.GetInvProductData();
