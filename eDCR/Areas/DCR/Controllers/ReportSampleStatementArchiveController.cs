...
{
    public class ReportSampleStatementArchiveController : Controller
    {
        ...
        public ActionResult frmReportSampleStatementArchive()
        {
        ...
        {
            var data = primaryDAO.GetMainGridDataArchive(model);
