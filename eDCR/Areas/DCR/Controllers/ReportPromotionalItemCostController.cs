...
{
    public class ReportPromotionalItemCostController : Controller
    {
        ...
        public ActionResult frmReportPromotionalItemCost()
        {
        ...
        {
            var listData = promotionalItemViewDAO.ReportPromotionalItemCost(model);
        ...
        public ActionResult Export(DefaultParameterBEO model)
        {
            ...
            string FileName = "Promotional_Item_Cost_" + DateTime.Now.ToString("yyyyMMdd");

            string vHeader = "Promotional Item Cost";

            var tuple = promotionalItemViewDAO.ExportCost(model);
        ...
        protected PdfPTable Add_Content_To_PDF(PdfPTable tableLayout, int PdfNoOfColumns, DataTable dt, List<ReportPromotionalItemExecuion> item, string vHeaderSubject, string vHeaderParameter)
        {
            ...
            float[] headers = { 8,10, 15, 10, 15, 10, 20, 10, 10, 10, 30, 10, 10, 10,10 }; //Header Widths  
            ...
            ////Add header
            AddCellToHeader(tableLayout, "SL", 1);
            ...
            AddCellToHeader(tableLayout, "Promotional Cost", 1);
            ...
            foreach (var emp in item)
            {
                ...
                AddCellToBody(tableLayout, emp.PromotionalCost);
