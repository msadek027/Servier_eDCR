...
{
    public class ReportDoctorCoverageController : Controller
    {
        ...
        public ActionResult frmReportDoctorCoverage()
        {
        ...
        {
            var data = primaryDAO.GetDoctorCoverage(model);
        ...
        public ActionResult Export(DefaultParameterBEO model)
        {
            ...
            string FileName = "Doctor_Coverage_" + DateTime.Now.ToString("yyyyMMdd");

            string vHeader = "Doctor Coverage";
