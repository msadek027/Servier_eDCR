...
{
    public class ReportExpenseBillMpoTmRsmController : Controller
    {
        ...
        public ActionResult frmReportExpenseBillMpoTmRsm()
        {
        ...
        public ActionResult frmReportExpenseBillMpoTmRsmDetail()
        {
            if (Session["UserID"] != null)
            {
                return View();
        ...
        {
            var data = primaryDAO.GetViewExpenseBillSummaryMpoTmRsm(model);
        ...
        public ActionResult GetExportExpenseBillSummaryMpoTmRsm(DefaultParameterBEO model)
        {
            ...
            var tuple = primaryDAO.GetExportExpenseBillSummaryMpoTmRsm(model);
    ...
    protected PdfPTable Add_Content_To_PDF(PdfPTable tableLayout, int PdfNoOfColumns, DataTable dt, List<ReportExpenseBillSummaryMpoTmRsmDepotBEO> item, string vHeaderSubject, string vHeaderParameter)
        {
        ...
        [HttpPost]
        public ActionResult GetDA(DefaultParameterBEO model)
        {
            var data = reportExpenseBillMpoTmRsmDAO.GetDA(model);

             return Json(data, JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        public ActionResult GetDefaultDA(DefaultParameterBEO model)
        {
            var data = reportExpenseBillMpoTmRsmDAO.GetDefaultDA(model);

            return Json(data, JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        public ActionResult GetTA(DefaultParameterBEO model)
        {
            var data = reportExpenseBillMpoTmRsmDAO.GetTA(model);
            return Json(data, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult ExportDetail(DefaultParameterBEO model)
        {
            ...
            var tuple = primaryDAO.GetExportExpenseBillDetailMpoTmRsm(model);
            string vParameter = tuple.Item1;
            DataTable dt = tuple.Item2;
            var dataList = tuple.Item3;
