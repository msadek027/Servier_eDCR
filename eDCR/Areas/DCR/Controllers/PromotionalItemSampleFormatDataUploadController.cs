...
{
    public class PromotionalItemSampleFormatDataUploadController : Controller
    {
        ExceptionHandler exceptionHandler = new ExceptionHandler();
        PromotionalItemUploadDAO IteamsUploadDAO = new PromotionalItemUploadDAO();
        Object listData = null;

        public ActionResult frmPromotionalItemSampleFormatDataUpload()
        {
        ...
        public ActionResult LoadExcelFile(string fileName, string FileType)
        {
            ...
            try
            {
                ...
                excelConnection.Close();
                    ...
                    listData = IteamsUploadDAO.GetSampleFormatDataMap(dt);
                ...
                if (d.Length > 0)
                {
                    if (fileExtension == ".txt")
                    {
                        ...
                        foreach (string line in lines)
                        {
                            ...
                            dr["ProductCode"] = word[1].ToString();
                            dr["Quantity"] = word[2].ToString();
        ...
        public ActionResult OperationsMode(PromotionalItemFormatDataUploadBEO model)
        {
            try
            {
                if (IteamsUploadDAO.SaveUpdateSampleFormatData(model))
                {
