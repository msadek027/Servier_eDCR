...
{
    public class PromotionalItemUploadController : Controller
    {
        ExceptionHandler exceptionHandler = new ExceptionHandler();
        PromotionalItemUploadDAO IteamsUploadDAO = new PromotionalItemUploadDAO();

        public ActionResult frmPromotionalItemUpload()
        {
        ...
        {
            string FileName = "PromotionalItemUpload.xlsx";
        ...
        {
            fileName = "PromotionalItemUpload.xlsx";
        ...
        [HttpPost]
        public ActionResult GetGridData( string MonthNumber, string Year)
        {
            var listData = IteamsUploadDAO.GetSampleAllData(MonthNumber, Year);
