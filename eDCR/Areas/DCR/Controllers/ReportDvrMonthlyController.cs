...
{
    public class ReportDvrMonthlyController : Controller
    {
        ...
        public ActionResult frmReportDvrMonthly()
        {
        ...
        public ActionResult frmReportDvrMonthly2()
        {
            if (Session["UserID"] != null)
            {
                return View();
        ...
        [HttpPost]
        public ActionResult GetDvrWpDcr(DefaultParameterBEO model)
        {
            var data = primaryDAO.GetDvrWpDcr(model);
            return Json(new { data=data, DvrWpDcrStatus = primaryDAO.DvrWpDcrStatus, DvrStatus = primaryDAO.IsDvrStatus, Status = "Yes" });
