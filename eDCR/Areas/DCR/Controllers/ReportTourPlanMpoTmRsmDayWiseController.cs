...
{
    public class ReportTourPlanMpoTmRsmDayWiseController : Controller
    {
        ExportToAnother export = new ExportToAnother();
        ReportTourPlanViewRegionWiseDAO primaryDAO = new ReportTourPlanViewRegionWiseDAO();
        DefaultReportHeaderBEO reportHeader = new DefaultReportHeaderBEO();
        ExceptionHandler exceptionHandler = new ExceptionHandler();
        public ActionResult frmReportTourPlanMpoTmRsmDayWise()
        {
        ...
        public ActionResult Export(DefaultParameterBEO model)
        {
            ...
            string FileName = "TP_" + DateTime.Now.ToString("yyyyMMdd");
       ...
       protected PdfPTable Add_Content_To_PDF(PdfPTable tableLayout, int PdfNoOfColumns, DataTable dt, List<ReportTourPlanViewRegionWiseBEO> item, string vHeaderSubject, string vHeaderParameter)
        {

            float[] headers = { 30,25, 20, 30, 30, 20, 30, 20, 30, 30, 20, 30, 20 }; //Header Widths  
